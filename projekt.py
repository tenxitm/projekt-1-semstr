...
def voting():
    ...
    if max_glosow == suma_zulty:
        ...
        print("Osoba z największą liczbą głosów was ejected.")
        kolor.remove(sprawdzienie_glosow)
    ...
    if mój_kolor == impostor:
        ...
        while True:
            if losowanie_zagadki == 1:
                ...
                print('CO NIE JE NIE PIJE ALE CHODZI I BIJE? ...')
